                  ...
                  {dayItems.map((item, idx) => (
                    <div key={item.id || idx} className="relative bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition">
                      ...
                      <div className="flex justify-between items-start mb-2">
                        <span className="text-xs font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-900/30 px-2 py-1 rounded flex items-center gap-1">                          {getIcon(item.time_slot)} {item.time_slot}
                        </span>
