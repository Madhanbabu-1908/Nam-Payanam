  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#0f172a] text-white overflow-hidden">
      ...
      <div className="relative z-10 mb-10 scale-125">
        <svg width="220" height="140" viewBox="0 0 200 120" fill="none" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">          
          {/* 
             EXACT PATH TRACED FROM YOUR IMAGE 
             This creates the specific angular body, flat bottom, and tail shape.
          */}
          <motion.path
          ...
          {/* Speed Lines (Left Dashes) */}
          <motion.path d="M 15 52 L 28 52" strokeOpacity="0.6" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.1 }} />
          <motion.path d="M 10 72 L 23 72" strokeOpacity="0.6" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.1 }} />
          <motion.path d="M 20 42 L 30 42" strokeOpacity="0.4" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.1 }} />

          {/* Clouds/Exhaust (Right Puffs) */}          <motion.path d="M 185 38 Q 190 33 195 38" fill="none" strokeOpacity="0.6" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.5 }} />
          <motion.path d="M 190 55 Q 195 50 200 55" fill="none" strokeOpacity="0.6" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.5 }} />
